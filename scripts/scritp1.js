...
let headerOriginal = document.querySelector(".header_N1");
let headerNuevo = document.querySelector(".header_N1_1");

let isHeaderVisible = true; //variable para verificar la "aparicion" del segundo header
